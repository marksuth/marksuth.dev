...
test('post collection model can be instantiated', function () {
    $postCollection = new PostCollection;
    expect($postCollection)->toBeInstanceOf(PostCollection::class);
});

test('post collection model has correct casts', function () {
    $postCollection = new PostCollection;
    expect($postCollection->getCasts())
        ->toHaveKey('meta', 'array');
});

test('post collection model has correct table name', function () {
    $postCollection = new PostCollection;
    expect($postCollection->getTable())->toBe('post_collections');
});

test('post collection model has posts relationship', function () {
    $postCollection = new PostCollection;
